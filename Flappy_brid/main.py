...
parser.add_argument('--init_e', type=float, help='initial epsilon for epsilon-greedy exploration', default=0.9)
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        resume = not args.weight == ""  # 是否在预先训练的模型上训练
        MSIC.train(model, args, resume)
    else:
        MSIC.play("model_best.pth.tar")
